...
((MICROS/WALKER:COLLECT-HIGHLIGHT-PATHS
 ...
 ((1 8 2) (2 2)))
((MICROS/WALKER:COLLECT-HIGHLIGHT-PATHS
  (LOOP :FOR MICROS/WALKER::X :FROM 1 :TO 10
        :INITIALLY (PRINT MICROS/WALKER::Y)
        :COLLECT (* MICROS/WALKER::X 2) :INTO MICROS/WALKER::Y
        :FINALLY (MICROS/WALKER::F MICROS/WALKER::X MICROS/WALKER::Y))
  (1 14))
 ((1 10) (2) (1 14)))
((MICROS/WALKER:COLLECT-HIGHLIGHT-PATHS
  (LOOP :FOR MICROS/WALKER::X :FROM 1 :TO 10
...
((MICROS/WALKER:COLLECT-HIGHLIGHT-PATHS
  (LOOP :FOR MICROS/WALKER::X :FROM 1 :TO 10
        :INITIALLY (PRINT MICROS/WALKER::FOO)
        :COLLECT MICROS/WALKER::X :INTO MICROS/WALKER::FOO
        :FINALLY (RETURN MICROS/WALKER::FOO))
  (10))
 ((10) (2)))
((MICROS/WALKER:COLLECT-HIGHLIGHT-PATHS
  (LOOP :FOR MICROS/WALKER::X :FROM 1 :TO 10
 ...
 ((10) (2)))
((MICROS/WALKER:COLLECT-HIGHLIGHT-PATHS
  (LET ((MICROS/WALKER::X 1))
    (LOOP :FOR MICROS/WALKER::X :FROM MICROS/WALKER::X :TO 10
          :COLLECT MICROS/WALKER::X))
  (8 2))
 ((8 2) (2 2)))
((MICROS/WALKER:COLLECT-HIGHLIGHT-PATHS
  (LET ((MICROS/WALKER::X 1))
...
((MICROS/WALKER:COLLECT-HIGHLIGHT-PATHS
 ...
 ((4 2) (0 0 1)))
((MICROS/WALKER:COLLECT-HIGHLIGHT-PATHS
  (LOOP :FOR MICROS/WALKER::X :FROM 0 :TO 10
        :COLLECT (MICROS/WALKER::F MICROS/WALKER::X))
  (1 8))
 ((1 8) (2)))
((MICROS/WALKER:COLLECT-HIGHLIGHT-PATHS
  (LOOP :FOR MICROS/WALKER::X :FROM 0 :TO 10
